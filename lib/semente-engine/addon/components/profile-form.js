...
avancarLabel: 'Avançar',
  ...
  actions: {
    ...
    buscarArquivoAvatar: function(event) {
      debugger;
      const file = event.target.files[0];
      this.set('selected_file_avatar', file.name);
      let bloburl = URL.createObjectURL(file);
      document.getElementById("avatar-modale").style.backgroundImage = "url(" + bloburl + ")";
    },
