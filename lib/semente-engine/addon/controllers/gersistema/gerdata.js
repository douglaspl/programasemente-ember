  ...
  actions: {
    ...
    userModal(param) {
      ...
      if (param) {
        ...
        this.set('new_user_birth', pessoa.get('nascimento'));
    ...
    userSave(param) {
      ...
      let matricula = document.getElementById('new_user_subsc').value;
      let nascimento = document.getElementById('new_user_birth').value;
      let inst = this.get('inst_selected');
