  ...
  actions: {
    ...
    cancelAreaAction(param) {
      if (param === 'new') {
        ...
        document.getElementById('newAreaName').innerHTML = null;
        document.getElementById('newArea').style.display = 'none';
      } else {
        let itemEdit = document.getElementById('areaItemName' + param);

        itemEdit.contentEditable = false;
        itemEdit.innerHTML = this.get('areaToEdit.name');
        this.set('areaToEdit.name', null);
        this.set('areaToEdit.id', null);
    ...
    addArea() {
      ...
      let name = document.getElementById('newAreaName').innerHTML;
      let inst = this.get('inst_selected');
      let area_info = {
        'name': name,
        'instituicao': inst
    ...
    editArea(param) {
      ...
      if (prevId !== null) {
        ...
        prevToEdit.innerHTML = this.get('areaToEdit.name');
        prevToEdit.contentEditable = false;
      ...
      this.set('areaToEdit.name', targetArea.innerHTML);
    ...
    saveArea(param) {
      ...
      let errors = 0;
      let name = document.getElementById('areaItemName' + param).innerHTML;
      ...
      if (area.get('name') !== name && name !== null && name !== '' && name !== ' ' && name.length >= 5) {
        ...
        area.save().then(() => {
          ...
          document.getElementById('areaItemName' + param).contentEditable = false;
