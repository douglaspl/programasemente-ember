...
export default Controller.extend({
  ...
  modulos_list: Ember.computed('model',function(){
    let listaModulos = [];
    this.get('model').included.forEach(function(modulo){
      if(modulo.type=='modulo'){
        let modlist = {
          'id': modulo.id,
          'name': modulo.attributes.name,
          'coverImg': modulo.attributes['cover-image'],
        }
