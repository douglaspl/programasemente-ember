...
export default Controller.extend({
  ...
  }).property('search', 'selectedTipo', 'selectedCal', 'selectedTema', 'selectedAgrupamento', 'selectedPublico', 'selectedSegmento', 'selectedAno', 'selectedAula', 'show', 'selectedSituacao'),
