  ...
  actions: {
    ...
    sendSuggestion() {
      ...
      let mailBody =
        ...
        "<h1 style='text-transform: uppercase; font-size: 20px; letter-spacing: .1em; border-bottom: 1px solid #efeff0; margin: 0 0 24px; padding-bottom: 8px;'>Sugestão para <span class='color-link--deepblue'>" + aula + "</span> | <span class='color-link--deepblue'>" + ano + " </span> | <span class='color-link--deepblue'>" + segmento + "</span></h1>" +
