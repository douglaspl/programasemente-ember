...
export default Ember.Controller.extend({
    ...
    if (obj) {
      ...
      Ember.run.schedule('afterRender', function () {
        ...
        if (that.get('hasModulo')){
          if (obj.role == 'aluno') {
            that.transitionToRoute('aulas.modulos.modlist', that.get('ModuloIdx'));
          } else {
  ...
  actions: {
    ...
    goToModulo(id){
      this.transitionToRoute('aulas.modulos.modlist',id);
    },
    goToBiblioteca(){
        ...
        if (pessoa.id === param) {
          ...
          if (pessoa.attributes.role == 'aluno') {
            if (this.get('hasModulo')){
              this.transitionToRoute('aulas.modulos.modlist', that.get('ModuloIdx'));
            }else{
