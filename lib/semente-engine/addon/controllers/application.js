...
export default Ember.Controller.extend({
  ...
  oneInst: Ember.computed('model', function () {
    ...
    if (obj) {
      ...
      Ember.run.schedule('afterRender', function () {
        ...
        if (obj.role == 'aluno') that.transitionToRoute('modulos.modlist', 3);
      ...
      if (inst_array) {
        if (inst_array.length === 1) {
          ...
          Ember.run.schedule('afterRender', function () {
            ...
            if (pessoa.attributes.role == 'aluno') that.transitionToRoute('modulos.modlist', 3);
            else that.transitionToRoute('administracao');
            // #########################################
            // #########################################
            // #########################################
  ...
  setTitle: function () {
    ...
    if (path.search('/modulos') > -1) {
      courses.firstChild.classList.add("global-nav__link--is-active");
    ...
    selectPessoa: function (param) {
      ...
      data.forEach((pessoa) => {
        if (pessoa.id === param) {
          ...
          if (pessoa.attributes.role == 'aluno') this.transitionToRoute('modulos.modlist', 3);
