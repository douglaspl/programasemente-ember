...
export default Ember.Controller.extend({
  ...
  primeiroAno: Ember.computed('model', function () {
    ...
    if(this.get('model').included.find(function(obj){return obj.type=='modulo' && obj.id==1})) return true;

  }),
  segundoAno: Ember.computed('model', function () {

    if(this.get('model').included.find(function(obj){return obj.type=='modulo' && obj.id==2})) return true;
    
  }),
  terceiroAno: Ember.computed('model', function () {

    if(this.get('model').included.find(function(obj){return obj.type=='modulo' && obj.id==3})) return true;
