  ...
  oneInst: Ember.computed('model', function () {
    ...
    if (obj) {
      ...
      Ember.run.schedule('afterRender', function () {
        ...
        if (obj.role == 'aluno') that.transitionToRoute('modulos');
      ...
      if (inst_array) {
        if (inst_array.length === 1) {
          ...
          Ember.run.schedule('afterRender', function () {
            ...
            if (pessoa.attributes.role == 'aluno') that.transitionToRoute('modulos');
            else that.transitionToRoute('administracao');
            // #########################################
            // #########################################
            // #########################################
    ...
    selectPessoa: function (param) {
      ...
      data.forEach((pessoa) => {
        if (pessoa.id === param) {
          ...
          if (pessoa.attributes.role == 'aluno') this.transitionToRoute('modulos');
