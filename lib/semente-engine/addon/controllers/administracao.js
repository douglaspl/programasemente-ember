...
export default Controller.extend({
  ...
  actions: {
    ...
    downloadFile() {
      ...
      if (document.getElementById('button_tab_pessoas').classList.contains('tabs__tab--is-active')) window.location.href = this.get('envnmt.host') + '/' + this.get('envnmt.namespace') + '/relatorios/alunos?pessoaId=' + user;
