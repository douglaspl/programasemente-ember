...
export default Controller.extend({
  ...
  actions: {
    ...
    async selectInst(id) {
      ...
      if (id !== 'none') {
        let inst_selected = await this.get('store').findRecord('instituicao', id, {
          include: 'modulos, acompanhamentos-curso-instituicao, modulos.atividades, acompanhamentos-atividade-instituicao, turmas.acompanhamentos-atividade-turma, instituicao-filhas.turmas.modulo'
        });
    ...
    goToAtividade(mod_id, atv_id){
      ...
      this.transitionToRoute('aulas.modulos.modetails.ativdetails.secdetails', this.get('model'), atv_id, secaoId);
    },
