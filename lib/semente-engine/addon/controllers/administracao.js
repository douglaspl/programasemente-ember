    ...
    async selectInst(id) {
      ...
      if (id !== 'none') {
        let inst_selected = await this.get('store').findRecord('instituicao', id, {
          include: 'modulos, acompanhamentos-curso-instituicao, modulos.atividades, acompanhamentos-atividade-instituicao, modulos.atividades.secoes, modulos.atividades.secoes.conteudos, modulos.atividades.secoes.conteudos.quiz, modulos.atividades.secoes.conteudos.quiz.questoes.estados-questao, modulos.atividades.secoes.conteudos.quiz.questoes.alternativas, modulos.atividades.secoes.conteudos.htmls, modulos.atividades.secoes.conteudos.videos, turmas.acompanhamentos-atividade-turma'
        });
