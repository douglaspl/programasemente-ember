...
export default Route.extend({
  ...
  model(id) {
    return this.get('store').findRecord('pessoa', id.pessoa_id, {
      include: 'responsaveis, plataforma-anos, instituicao.plataforma-anos.segmentos, instituicao.plataforma-turmas, plataforma-turmas, modulos, dependentes.plataforma-turmas',
      reload: true
    });
  },
