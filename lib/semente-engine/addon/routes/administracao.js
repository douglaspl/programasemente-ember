...
export default Route.extend({
  ...
  model() {
    ...
    if (role === 'admin') {
      ...
      // });
      return this.get('store').findRecord('instituicao', inst_id, {
        include: 'acompanhamentos-curso-instituicao, acompanhamentos-atividade-instituicao, turmas.acompanhamentos-atividade-turma, modulos, turmas.acompanhamentos-atividade-turma'
      });
    }
  }
});
