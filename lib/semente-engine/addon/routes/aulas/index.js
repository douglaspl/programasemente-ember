...
export default Route.extend({
    ...
    model() {
        ...
        return this.get('store').findRecord('pessoa', person_id, {include: 'instituicao, plataforma-anos.segmento, plataforma-anos.aulas.unidade, plataforma-anos.aulas.plataforma-conteudos, dependentes.plataforma-anos.aulas.plataforma-conteudos, plataforma-anos.livros, plataforma-turmas.aplicacoes-plataforma-aula.aula, dependentes.plataforma-anos.aulas.unidade, dependentes.plataforma-turmas.aplicacoes-plataforma-aula.aula, dependentes.plataforma-anos.segmento, dependentes.plataforma-anos.livros', reload: true});
    },
